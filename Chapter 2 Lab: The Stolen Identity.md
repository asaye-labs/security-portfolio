# [The Stolen Identity, "A walk through an identity kill-chain using a confused deputy attack."]

<img width="2662" height="1246" alt="Chapter 2 banner" src="https://github.com/user-attachments/assets/c2e0e6da-ee27-470a-a8fe-1e27535756af" />
...
<img width="3821" height="1820" alt="Chapter 2 objective 1 found the flag in the note of the legacy app" src="https://github.com/user-attachments/assets/9759c0d9-6809-46d6-917f-fa5d8320839d" />
...
<img width="3832" height="1817" alt="Chapter 2 objective 2 there was a flag in the certificates and secrets blade that had a VERY suspicious expiration" src="https://github.com/user-attachments/assets/f1664399-8c37-4ad3-a628-dcbe197c5995" />
...
<img width="3824" height="1809" alt="Chapter 2 objective 3 pivoted and found another flag within the Mad-Hat-Labs-App" src="https://github.com/user-attachments/assets/e074a188-f868-400c-a34c-546c128a2624" />
...
<img width="3835" height="1821" alt="Chapter 2 objective 4 the attacker left a hidden flag to leave a persistence trail including another flag when looking at the expose an API blade" src="https://github.com/user-attachments/assets/9dbd0846-432c-41f9-b822-783484f9fd0e" />
...
<img width="3816" height="1813" alt="Chapter 2 objective 5 when looking at the authentication blade of the Mad-Hat-Labs-App i saw the attacker setup a redirected URI" src="https://github.com/user-attachments/assets/49c3455e-0eae-4e04-8650-86cd3f6fe3fd" />
...
- I was surprised that any standard user can register an app by default, and that owning an app registration is effectively an unlogged privilege path that a review of Global Admins would completely miss.
